...
class Mega2GUI(Node):
    """
    Simple GUI for controlling Arduino Mega2 relay
    """
    
    def __init__(self):
        super().__init__('mega2_gui')
        ...
        self.get_logger().info('Mega2 GUI Node Started')
    
    def setup_gui(self):
        """Create the GUI interface"""
        self.root = tk.Tk()
        self.root.title("Mega2 Relay & Sensor Controller")
        ...
        # Title
        title_label = ttk.Label(main_frame, text="Arduino Mega2 Relay & Sensor Controller", 
                               font=('Arial', 14, 'bold'))
        ...
        ttk.Label(info_frame, text="Arduino IP: 192.168.100.102:8888", 
                 font=('Arial', 10)).grid(row=0, column=0, sticky=tk.W)
        ttk.Label(info_frame, text="ROS2 Nodes: m2relay, m2sensor", 
