...
class Mega6RelayNode(Node):
    def __init__(self):
        super().__init__('m6relay_node')
        
        # Publishers
        self.status_publisher = self.create_publisher(String, 'mega6/relay_status', 10)
        self.state_publisher = self.create_publisher(Bool, 'mega6/relay_state', 10)
        ...
        self.get_logger().info('Mega6 Relay node started.')
