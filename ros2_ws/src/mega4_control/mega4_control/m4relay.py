...
class Mega4RelayNode(Node):
    def __init__(self):
        super().__init__('m4relay_node')
        
        # Publishers
        self.status_publisher = self.create_publisher(String, 'mega4/relay_status', 10)
        self.state_publisher = self.create_publisher(Bool, 'mega4/relay_state', 10)
        ...
        self.get_logger().info('Mega4 Relay node started.')
