...
// PERFORMANCE OPTIMIZED FIRMWARE - MEGA5
// File: mega5.cpp
// IP: 192.168.100.105
// MAC: 0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0x05
// Minimal overhead, maximum speed

// Network configuration - MEGA5
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("OPTIMIZED RELAY & SENSOR CONTROLLER MEGA5 READY");
  Serial.print("IP: ");
  Serial.println(ip);
}
