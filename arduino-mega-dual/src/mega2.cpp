...
// PERFORMANCE OPTIMIZED FIRMWARE - MEGA2
// File: mega2.cpp  
// IP: 192.168.100.102
// MAC: 0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0x02
// Minimal overhead, maximum speed

// Network configuration - MEGA2 uses different MAC and IP
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("OPTIMIZED RELAY & SENSOR CONTROLLER MEGA2 READY");
  Serial.print("IP: ");
  Serial.println(ip);
}
