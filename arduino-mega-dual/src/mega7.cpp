...
// PERFORMANCE OPTIMIZED FIRMWARE - MEGA7
// File: mega7.cpp
// IP: 192.168.100.107
// MAC: 0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0x07
// Minimal overhead, maximum speed

// Network configuration - MEGA7
byte mac[] = {0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0x07};
IPAddress ip(192, 168, 100, 107);
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("OPTIMIZED RELAY & SENSOR CONTROLLER MEGA7 READY");
  Serial.print("IP: ");
  Serial.println(ip);
}
